...
public class MyAgent implements Agent
{
	...
	private double playclock; // this is how much time (in seconds) we have before nextAction needs to return a move
    ...
    public String nextAction(int[] lastMove) {
		...
		if (lastMove != null) {
			...
			String roleOfLastPlayer = (myTurn && role.equals("white")) || (!myTurn && role.equals("black")) ? "white" : "black";
			System.out.println(roleOfLastPlayer + " moved from " + last_move.x1 + "," + last_move.y1 + " to " + last_move.x2 + "," + last_move.y2);
